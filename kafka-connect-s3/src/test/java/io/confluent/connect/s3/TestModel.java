...
public class TestModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord  {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TestModel\",\"namespace\":\"io.confluent.connect.s3\",\"fields\":[{\"name\":\"userType\",\"type\":[\"null\",{\"type\":\"enum\",\"name\":\"UserType\",\"symbols\":[\"ANONYMOUS\",\"REGISTERED\"]}],\"default\":null}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
  private io.confluent.connect.s3.UserType userType;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      case 0: userType = (io.confluent.connect.s3.UserType)value$; break;
      default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public io.confluent.connect.s3.UserType getUserType() {
    return userType;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TestModel>
    ...
    public TestModel.Builder setUserType(io.confluent.connect.s3.UserType value) {
    ...
    public TestModel build() {
      try {
        ...
        record.userType = fieldSetFlags()[0] ? this.userType : (io.confluent.connect.s3.UserType) defaultValue(fields()[0]);
        return record;
      } catch (Exception e) {
